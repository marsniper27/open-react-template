...
export default function HelpSidebar() {
  ...
  const links = [
    ...
    },
    {
      ...
      href: '/help/data-analysis'
    },
    {
      name: 'What is Data Engineering',
      href: '/help/data-engineering'
    },
    {
      name: 'What is Data Science',
      href: '/help/data-science'
    }
  ]  
        ...
        <ul>
          {links.map((link, linkIndex) => (
            <li key={linkIndex} className="py-2 border-b border-gray-800">
              <Link className={`flex items-center px-3 group transition duration-150 ease-in-out ${pathname === link.href ? 'text-purple-600' : 'text-gray-700 hover:text-purple-600'}`} href={link.href}>
                <span>{link.name}</span>
